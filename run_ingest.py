...
def _run_curated_diverse(args: argparse.Namespace) -> int:
    """Run the curated diverse adapter."""
    ...
    print("\nCurated diverse ingestion complete:")
    print(f"  Images processed: {result.images_processed}")
    print(f"  Images skipped:   {result.images_skipped}")
    print(f"  Errors:           {len(result.errors)}")
    print(f"  Output directory:  {args.output_dir}")
...
_ADAPTERS = {
    ...
    "curated_diverse": _run_curated_diverse,
}
