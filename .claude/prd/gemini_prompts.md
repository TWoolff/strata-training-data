...
TS-001. Character turnaround sheet of a friendly penguin postman wearing a blue postal cap, a small mailbag slung across the body, and tiny boots. Gouache children's book illustration style with visible brushstrokes and soft cool colors. Show 5 views in a single row on the same sheet: front view, front 3/4 view, side view, back 3/4 view, and back view. All views must be the exact same character at the same scale in a neutral standing pose. Solid plain white background. Label each view below it.

TS-002. Character turnaround sheet of a round hedgehog baker in a flour-dusted apron, a tiny chef's hat, and oven mitts, holding a fresh pie. Gouache children's book illustration style with warm earthy tones and thick brushstrokes. Show 5 views in a single row: front, front 3/4, side, back 3/4, back. Same character, same scale, neutral pose. Solid white background. Label each view.

TS-003. Character turnaround sheet of a tall giraffe librarian wearing round spectacles, a cardigan, and carrying a stack of books under one arm. Gouache children's book style with soft yellows and browns. Show 5 views in a single row: front, front 3/4, side, back 3/4, back. Same character, same scale, neutral pose. Solid white background. Label each view.

TS-004. Character turnaround sheet of a chubby cat wizard in a starry purple robe, a pointy hat, and holding a glowing wand. Gouache children's book style with magical purples and golds. Show 5 views in a single row: front, front 3/4, side, back 3/4, back. Same character, same scale, neutral pose. Solid white background. Label each view.

TS-005. Character turnaround sheet of a small mouse knight in oversized plate armor, a shield with a cheese emblem, and a toothpick sword. Gouache children's book style with shiny metallic tones. Show 5 views in a single row: front, front 3/4, side, back 3/4, back. Same character, same scale, neutral pose. Solid white background. Label each view.

### Anime / Game Art Style

TS-006. Character turnaround sheet of a cyberpunk street samurai in a long neon-trimmed coat, tactical pants, combat boots, a katana on the back, and glowing cybernetic arm. Anime cel-shaded style. Show 5 views in a single row: front, front 3/4, side, back 3/4, back. Same character, same scale, A-pose (arms at 45 degrees). Solid white background. Label each view.

TS-007. Character turnaround sheet of a magical girl in a frilly pastel dress with a bow, knee-high boots, fingerless gloves, and a star-tipped wand. Anime style with soft shading. Show 5 views in a single row: front, front 3/4, side, back 3/4, back. Same character, same scale, A-pose. Solid white background. Label each view.

TS-008. Character turnaround sheet of a dark elf ranger in leather armor, a hooded forest cloak, knee-high boots, a quiver on the back, and a longbow. Fantasy RPG anime style. Show 5 views in a single row: front, front 3/4, side, back 3/4, back. Same character, same scale, A-pose. Solid white background. Label each view.

TS-009. Character turnaround sheet of a mech pilot in a flight suit with patches, a helmet under one arm, magnetic boots, and a comm unit on the wrist. Gundam-inspired anime style. Show 5 views in a single row: front, front 3/4, side, back 3/4, back. Same character, same scale, A-pose. Solid white background. Label each view.

TS-010. Character turnaround sheet of a fire mage in a red and gold robe with flame motifs, a sash belt, sandals, and flame dancing around the hands. JRPG character art style. Show 5 views in a single row: front, front 3/4, side, back 3/4, back. Same character, same scale, A-pose. Solid white background. Label each view.

### Watercolor Style

TS-011. Character turnaround sheet of an old fisherman in a yellow rain slicker, rubber boots, a wool cap, and holding a fishing rod over the shoulder. Loose watercolor illustration with visible paint bleeds and soft edges. Show 5 views in a single row: front, front 3/4, side, back 3/4, back. Same character, same scale, neutral pose. Solid white background. Label each view.

TS-012. Character turnaround sheet of a ballerina in a white tutu, pink pointe shoes, hair in a tight bun, and arms in first position. Elegant watercolor with delicate washes and fine lines. Show 5 views in a single row: front, front 3/4, side, back 3/4, back. Same character, same scale, neutral standing pose. Solid white background. Label each view.

TS-013. Character turnaround sheet of a Victorian gentleman in a top hat, tailcoat, waistcoat, cravat, striped trousers, and polished shoes, with a walking cane. Refined watercolor with rich browns and golds. Show 5 views in a single row: front, front 3/4, side, back 3/4, back. Same character, same scale, neutral pose. Solid white background. Label each view.

TS-014. Character turnaround sheet of a young girl in a sundress, straw hat, sandals, and holding a bouquet of wildflowers. Light airy watercolor with bright spring colors. Show 5 views in a single row: front, front 3/4, side, back 3/4, back. Same character, same scale, neutral pose. Solid white background. Label each view.

TS-015. Character turnaround sheet of a pirate captain in a tricorn hat, long coat with gold trim, high boots, a cutlass at the hip, and an eyepatch. Dramatic watercolor with deep ocean blues and warm golds. Show 5 views in a single row: front, front 3/4, side, back 3/4, back. Same character, same scale, neutral pose. Solid white background. Label each view.

### Digital Painting / Concept Art Style

TS-016. Character turnaround sheet of a space marine in heavy power armor with a jetpack, a large rifle, shoulder-mounted lights, and a cracked visor showing one eye. Sci-fi concept art style with metallic textures. Show 5 views in a single row: front, front 3/4, side, back 3/4, back. Same character, same scale, A-pose. Solid white background. Label each view.

TS-017. Character turnaround sheet of a forest druid in layered cloth and leather robes, wooden staff with vines growing on it, bare feet, antler crown, and a small animal companion on the shoulder. Fantasy concept art style. Show 5 views in a single row: front, front 3/4, side, back 3/4, back. Same character, same scale, A-pose. Solid white background. Label each view.

TS-018. Character turnaround sheet of a steampunk engineer in goggles, a leather work vest over a white shirt, tool belt, heavy boots, and mechanical gauntlets with gears. Victorian steampunk concept art. Show 5 views in a single row: front, front 3/4, side, back 3/4, back. Same character, same scale, A-pose. Solid white background. Label each view.

TS-019. Character turnaround sheet of an ice queen in a flowing crystalline gown, a crown of icicles, bare shoulders with frost patterns on the skin, and translucent cape. Fantasy concept art with cold blue and silver palette. Show 5 views in a single row: front, front 3/4, side, back 3/4, back. Same character, same scale, neutral pose. Solid white background. Label each view.

TS-020. Character turnaround sheet of a post-apocalyptic scavenger in patched together armor from car parts and road signs, gas mask hanging at the neck, heavy boots, and a makeshift spear. Gritty concept art with rust and dust tones. Show 5 views in a single row: front, front 3/4, side, back 3/4, back. Same character, same scale, A-pose. Solid white background. Label each view.

### Flat Vector / Cartoon Style

TS-021. Character turnaround sheet of a superhero in a classic spandex suit with a cape, boots, gloves, a chest emblem (lightning bolt), and a domino mask. Clean flat vector cartoon style with bold colors. Show 5 views in a single row: front, front 3/4, side, back 3/4, back. Same character, same scale, A-pose. Solid white background. Label each view.

TS-022. Character turnaround sheet of a pizza delivery robot with a boxy body, wheeled feet, extending arms, a pizza warmer compartment in the chest, and a small antenna. Cute flat vector style with bright primary colors. Show 5 views in a single row: front, front 3/4, side, back 3/4, back. Same character, same scale, neutral pose. Solid white background. Label each view.

TS-023. Character turnaround sheet of a roller derby player in a tank top, short shorts, knee pads, elbow pads, quad skates, and a helmet with a star decal. Retro cartoon style with halftone dots. Show 5 views in a single row: front, front 3/4, side, back 3/4, back. Same character, same scale, neutral pose. Solid white background. Label each view.
...
TS-027. Character turnaround sheet of a ninja in traditional shinobi shozoku (black outfit), tabi boots, a face wrap, and a ninjato sword on the back. Dynamic ink brush style with bold black strokes. Show 5 views in a single row: front, front 3/4, side, back 3/4, back. Same character, same scale, A-pose. Solid white background. Label each view.

TS-028. Character turnaround sheet of a flapper dancer from the 1920s in a beaded fringe dress, T-strap heels, a feathered headband, long pearl necklace, and a cigarette holder. Art deco ink illustration style. Show 5 views in a single row: front, front 3/4, side, back 3/4, back. Same character, same scale, neutral pose. Solid white background. Label each view.

TS-029. Character turnaround sheet of an astronaut in a realistic NASA-style EVA suit, helmet with gold visor, life support backpack, and tethered tools. Technical ink illustration with cross-hatching. Show 5 views in a single row: front, front 3/4, side, back 3/4, back. Same character, same scale, A-pose. Solid white background. Label each view.

TS-030. Character turnaround sheet of a street artist in a hoodie with paint stains, baggy jeans, sneakers, a backpack full of spray cans, and a respirator mask pushed up on the forehead. Urban sketch style with marker rendering. Show 5 views in a single row: front, front 3/4, side, back 3/4, back. Same character, same scale, neutral pose. Solid white background. Label each view.

### Pixel Art Style

TS-031. Character turnaround sheet of a retro RPG warrior in plate armor, a sword and shield, a red cape, and a winged helmet. 32-bit pixel art style with clear pixel grid. Show 5 views in a single row: front, front 3/4, side, back 3/4, back. Same character, same scale, neutral pose. Solid white background. Label each view.

TS-032. Character turnaround sheet of a pixel art witch in a black dress, pointed hat, striped stockings, buckle shoes, and riding a broom. Retro 16-bit game sprite style. Show 5 views in a single row: front, front 3/4, side, back 3/4, back. Same character, same scale, neutral pose. Solid white background. Label each view.

### Diverse Body Types and Styles

TS-033. Character turnaround sheet of a sumo wrestler in a traditional mawashi loincloth, topknot hairstyle, bare feet, with a massive build. Gouache style with bold skin tones. Show 5 views in a single row: front, front 3/4, side, back 3/4, back. Same character, same scale, neutral pose. Solid white background. Label each view.

TS-034. Character turnaround sheet of a child explorer in cargo shorts, a safari vest, a pith helmet too big for their head, binoculars, and rubber rain boots. Cheerful children's book watercolor. Show 5 views in a single row: front, front 3/4, side, back 3/4, back. Same character, same scale, neutral pose. Solid white background. Label each view.

TS-035. Character turnaround sheet of a tall, thin alien diplomat in a flowing robe with geometric patterns, elongated limbs, large dark eyes, no hair, and elegant sandals. Sci-fi concept art with iridescent colors. Show 5 views in a single row: front, front 3/4, side, back 3/4, back. Same character, same scale, A-pose. Solid white background. Label each view.

TS-036. Character turnaround sheet of a muscular blacksmith in a leather apron over a bare chest, heavy work pants, boots, thick gloves, and holding a hammer over one shoulder. Oil painting style with warm forge light. Show 5 views in a single row: front, front 3/4, side, back 3/4, back. Same character, same scale, A-pose. Solid white background. Label each view.

TS-037. Character turnaround sheet of an elderly grandmother in a floral house dress, a cardigan, slippers, reading glasses on a chain, and holding a cup of tea. Cozy gouache illustration with soft warm colors. Show 5 views in a single row: front, front 3/4, side, back 3/4, back. Same character, same scale, neutral pose. Solid white background. Label each view.

TS-038. Character turnaround sheet of a dwarf warrior in chainmail, a horned helmet, thick leather belt with a battle axe, fur-lined boots, and a magnificent braided beard. Fantasy digital painting. Show 5 views in a single row: front, front 3/4, side, back 3/4, back. Same character, same scale, A-pose. Solid white background. Label each view.

TS-039. Character turnaround sheet of a K-pop idol in a trendy oversized blazer, crop top, pleated skirt, platform boots, and layered necklaces. Modern fashion illustration with clean lines and pastel highlights. Show 5 views in a single row: front, front 3/4, side, back 3/4, back. Same character, same scale, neutral pose. Solid white background. Label each view.

TS-040. Character turnaround sheet of a deep sea diver in an old-fashioned brass diving helmet, canvas suit, lead boots, and air hose, with barnacles growing on the shoulders. Vintage illustration style with muted ocean tones. Show 5 views in a single row: front, front 3/4, side, back 3/4, back. Same character, same scale, neutral pose. Solid white background. Label each view.

### Non-Human / Creature Characters

TS-041. Character turnaround sheet of a treant (tree creature) with a humanoid body made of bark and branches, moss for hair, glowing green eyes, and leaf-covered shoulders. Fantasy concept art with natural greens and browns. Show 5 views in a single row: front, front 3/4, side, back 3/4, back. Same character, same scale, A-pose. Solid white background. Label each view.

TS-042. Character turnaround sheet of a friendly dragon standing upright on hind legs, with small wings, a round belly, stubby arms, horns, and a curling tail. Cute children's book gouache. Show 5 views in a single row: front, front 3/4, side, back 3/4, back. Same character, same scale, neutral pose. Solid white background. Label each view.

TS-043. Character turnaround sheet of a wolf warrior in tribal leather armor, war paint on the fur, a bone necklace, wrapped forearms, and a stone-headed axe. Fantasy ink and watercolor style. Show 5 views in a single row: front, front 3/4, side, back 3/4, back. Same character, same scale, A-pose. Solid white background. Label each view.

TS-044. Character turnaround sheet of a slime creature shopkeeper wearing a tiny merchant hat and apron, with a transparent gelatinous body showing small items floating inside. Cute RPG game art style. Show 5 views in a single row: front, front 3/4, side, back 3/4, back. Same character, same scale, neutral pose. Solid white background. Label each view.

TS-045. Character turnaround sheet of a mechanical owl automaton with brass plating, glass dome head with visible gears, telescoping legs, and articulated wings with individual metal feathers. Steampunk watercolor. Show 5 views in a single row: front, front 3/4, side, back 3/4, back. Same character, same scale, neutral pose. Solid white background. Label each view.

### Mixed / Unique Styles

TS-046. Character turnaround sheet of a samurai in full armor rendered in traditional Japanese woodblock print (ukiyo-e) style with flat colors, bold outlines, and decorative patterns. Show 5 views in a single row: front, front 3/4, side, back 3/4, back. Same character, same scale, A-pose. Solid white background. Label each view.
